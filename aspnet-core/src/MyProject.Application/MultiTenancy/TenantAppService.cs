...
{
    [AbpAuthorize(PermissionNames.Tenant_List)]
    public class TenantAppService : AsyncCrudAppService<Tenant, TenantDto, int, PagedTenantResultRequestDto, CreateTenantDto, TenantDto>, ITenantAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Tenant_Edit)]
        public override Task<TenantDto> UpdateAsync(TenantDto input)
        {
            return base.UpdateAsync(input);
        }

        [AbpAuthorize(PermissionNames.Tenant_Create)]
        ...
        [AbpAuthorize(PermissionNames.Tenant_Delete)]
