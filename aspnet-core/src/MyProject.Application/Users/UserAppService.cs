...
namespace MyProject.Users
{
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        [AbpAuthorize(PermissionNames.User_Edit)]
        ...
        [AbpAuthorize(PermissionNames.User_UpdatePassword)]
        public async Task<bool> ChangePassword(ChangePasswordDto input)
        {
            if (_abpSession.UserId == null)
            {
                throw new UserFriendlyException(L("ReLoginErrorMessage"));
            }
        ...
        [AbpAuthorize(PermissionNames.User_Delete)]
        public async Task BulkDeleteAsync(List<long> ids)
        {
